...
import { ChevronDown, CircleStop, Clock, Menu, Pause, Play, Plus, X } from "lucide-react";
...
export default function Description() {
    const { openDescription, setOpenDescription, childCardDetails } = useIndexContext()
                            ...
                            <div className='flex items-start gap-2 w-full'>
                                ...
                                <div className='flex flex-col gap-4 w-full px-2'>
                                    <div className='flex justify-between items-center px-2'>
                                        ...
                                        <button
                                            className='bg-gray-200 text-sm rounded px-4 py-2 hover:bg-gray-300 cursor-pointer'
                                        >
                                            Hide Details
                                        </button>
                                    </div>
                                    ...
                                    <div className='flex justify-between px-4 p-2 '>
                                        ...
                                        <div className='gap-4'>
                                            ...
                                            <button> <CircleStop size={18} /> </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        ...
                                        <div className='flex items-end justify-between'>
                                            <div className='flex flex-col'>
                                                <p className='text-xs font-semibold rounded-full w-fit px-1.5 py-0.5 text-black bg-blue-500'>U</p>
                                                <div>-----------</div>
